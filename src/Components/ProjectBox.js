...
const  ProjectBox = ({ projectName}) => {
  ...
  const desc = {
    Credit_Risk_AnalysisDesc: "A credit risk analyst determines how creditworthy someone is based on their credit history. The research that a credit risk analyst conducts ultimately leads to the decision of whether a lender should issue a loan to an applicant. Credit risk analysts may also review and rate investments.",
    Credit_Risk_AnalysisGithub: "",
    Credit_Risk_AnalysisWebsite: "",
  
    Online_Shopping_StoreDesc: "Online Shopping System is a web-based project which is made for remote-shopping or shopping through the Internet. As the technology is being advanced the way of life is changing in accordance. Nowadays we can place the order for anything from our home. There is no need to go to the shop of the things we want. ",
    Online_Shopping_StoreGithub: "",
    Online_Shopping_StoreWebsite: "",
  
    Stoppage_of_WebAttacksDesc: "Machine learning helps stop web attacks by analyzing traffic patterns to detect anomalies and malicious behavior. Techniques like supervised learning use labeled datasets to identify threats such as SQL injection, XSS, or DDoS attacks. Unsupervised methods can flag new attack patterns by detecting deviations from normal behavior. ",
    Stoppage_of_WebAttacksGithub: "",
    Stoppage_of_WebAttacksWebsite: "",
  
    Face_Reaction_DetectionDesc: "Face reaction detection without machine learning relies on predefined algorithms and rule-based systems. These methods use image processing techniques, such as edge detection, feature extraction, and geometric modeling, to identify facial expressions. By analyzing changes in facial landmarks like eyes, eyebrows, and mouth, the system interprets basic emotions. However, these approaches are less adaptive and accurate compared to ML-based systems.",
    Face_Reaction_DetectionGithub: "",
    Face_Reaction_DetectionWebsite: ""   
